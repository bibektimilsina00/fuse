...
import httpx
from src.credentials.service import resolve_secret
from src.workflows.engine.nodes.base import BaseNode, NodeInput, NodeOutput, NodeSchema
...
class SlackNode(BaseNode):
    ...
    async def list_channels(
        ...
        from src.credentials.service import get_active_credential, resolve_secret
