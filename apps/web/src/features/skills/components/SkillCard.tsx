...
export function SkillCard({ skill, onDelete }: SkillCardProps) {
  ...
  return (
    <div
      className={cn(
        'group relative flex flex-col gap-3 rounded-lg border border-border-faint bg-bg p-4',
      ...
      <div className="relative flex items-start gap-3">
        ...
        <div className="relative z-10">
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-sm text-text-faint opacity-0 transition-opacity hover:bg-bg2 hover:text-text group-hover:opacity-100"
          ...
          {menuOpen && (
            <>
              ...
              />
              <div className="absolute right-0 top-8 z-30 w-[140px] overflow-hidden rounded-md border border-border-faint bg-bg2 shadow-[0_8px_24px_-8px_oklch(0_0_0/0.4)]">
                <Link
                  to={APP_ROUTES.SKILL_EDIT(skill.id)}
