  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex h-9 w-full items-center gap-2 rounded-[8px] border border-border-soft bg-bg2 px-3 text-sm text-left',
          'transition-[background-color,border-color] duration-[120ms] hover:border-border hover:bg-surface',
      ...
      {open && (
        <div className="absolute top-[calc(100%+4px)] left-0 right-0 z-50 max-h-52 overflow-y-auto rounded-[8px] border border-border-soft bg-popover p-1.5 shadow-dropdown animate-in fade-in-0 zoom-in-95 duration-[100ms]">
          {options.length === 0 && (
...
function ComboBox({ options, value, displayValue, onChange, placeholder, isLoading, allowCustom, disabled }: ComboBoxProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-[calc(100%+4px)] left-0 right-0 z-50 rounded-[8px] border border-border-soft bg-popover shadow-dropdown animate-in fade-in-0 zoom-in-95 duration-[100ms]">
  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        disabled={disabled}
        className={cn(
          'flex min-h-[36px] w-full items-center gap-1.5 rounded-[8px] border border-border-soft bg-bg2 p-1.5 pl-3 text-sm text-left',
          'transition-[background-color,border-color] duration-[120ms] hover:border-border',
          open && 'border-accent bg-surface-2',
          disabled && 'opacity-40 cursor-not-allowed',
        )}
      >
