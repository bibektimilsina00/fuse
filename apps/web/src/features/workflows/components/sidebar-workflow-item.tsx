...
const ROW_BASE =
  'flex items-center gap-[10px] py-[6px] px-[10px] rounded-md text-[13px] font-medium w-full cursor-pointer transition-colors duration-100 hover:bg-[var(--surface)] relative'

const MENU_BTN =
  'w-[22px] h-[22px] rounded-sm text-[var(--text-faint)] inline-flex items-center justify-center opacity-0 transition-all duration-100 shrink-0 hover:bg-[var(--surface-2)] hover:text-[var(--text)] group-hover/wf:opacity-100 [&_svg]:w-[13px] [&_svg]:h-[13px]'
