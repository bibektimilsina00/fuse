...
export function WorkflowDragOverlay({ activeWorkflow }: WorkflowDragOverlayProps) {
  ...
  return (
    <DragOverlay dropAnimation={null}>
      <div className="w-[220px] select-none pointer-events-none opacity-90 rotate-2 scale-[1.02] shadow-[0_12px_24px_-10px_oklch(0_0_0/0.8)] border border-[var(--border)] rounded-md bg-[var(--bg-2)]">
        <div className="flex items-center gap-[9px] pt-[6px] pr-[6px] pb-[6px] pl-[12px] rounded-md text-[12.5px] text-[var(--text)] font-medium">
          <span
          ...
          <button className="w-[22px] h-[22px] rounded-sm text-[var(--text-faint)] inline-flex items-center justify-center shrink-0">
            <Icons.More />
          </button>
        </div>
      </div>
