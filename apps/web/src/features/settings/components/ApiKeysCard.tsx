    ...
    <div className="bg-[var(--bg)] border border-[var(--border-faint)] rounded-lg overflow-hidden">
      ...
      <div className="p-6 flex flex-col gap-5">
        ...
        <div className="flex gap-3">
          <div className="flex items-center gap-2.5 px-3 h-[38px] flex-1 bg-[var(--bg-2)] border border-[var(--border-faint)] rounded-md focus-within:border-[var(--border)] transition-colors">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 h-[38px] rounded-md bg-[var(--text)] text-[var(--bg)] text-[13px] font-medium border-none cursor-pointer shrink-0 transition-colors hover:bg-[oklch(0.90_0.003_250)] disabled:opacity-50 disabled:cursor-default"
          >
        ...
        {/* Key list */}
        {apiKeys.length === 0 ? (
          <div className="flex flex-col items-center gap-2 py-8 border border-dashed border-[var(--border-faint)] rounded-md">
          ...
          <div className="flex flex-col gap-2">
            {apiKeys.map(k => (
              <div
                key={k.id}
                className="flex items-center gap-4 px-4 py-3 bg-[var(--bg-2)] border border-[var(--border-faint)] rounded-md hover:border-[var(--border-soft)] transition-colors group"
              >
                <div className="flex flex-col gap-1 flex-1 min-w-0">
                  <span className="text-[13px] font-medium text-[var(--text)] truncate">{k.name}</span>
                  <span className="font-mono text-[11px] text-[var(--text-faint)] bg-[var(--bg)] border border-[var(--border-faint)] px-2 py-0.5 rounded-sm w-fit select-all">
                    {k.key_preview}
                  </span>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-[12px] font-medium text-[var(--text-dim)] bg-transparent border border-transparent hover:border-[oklch(0.70_0.18_22/0.3)] hover:text-[var(--err)] hover:bg-[oklch(0.70_0.18_22/0.08)] transition-colors opacity-0 group-hover:opacity-100"
                  title="Revoke key"
                >
