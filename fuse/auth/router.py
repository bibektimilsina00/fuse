...
from fuse.auth.service import user_service
from fuse.auth.utils import (
...
def refresh_token(current_user: CurrentUser) -> Any:
    """
    Refresh tokens using a valid refresh token as authentication.
    """
